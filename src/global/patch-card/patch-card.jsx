...
const PatchCard = (props) => {
            ...
            if (Array.isArray(verify_status) && verify_status?.length > 0) {
                ...
                if (result_check) {
                    ...
                    if (call_redirect_ajax) {
                        ...
                        await axios.post(captwiki_data.ajax_url, form);
                    }
    ...
    const Download_patch_content = () => {
        ...
        return (
            <div className='captwiki-download-patch'>
                <div className='captwiki-download-patch-status'>
                    <span className='captwiki-download-patch-status-icon'>
                        {check_plugin_detail('icon')}
                    </span>
                    <span className='captwiki-download-patch-status-text'>
    ...
    const Download_success_content = () => {
        return (
            <div className='captwiki-download-success-content'>
                <span className='captwiki-download-success-icon'>
                ...
                <div className='captwiki-download-success-actions'>
                    <Primary_button
                        text='Browse More'
    ...
    const cardFooter = () => {
        if (props.type == 'browse_page') {
            if (downloadLoader) {
                ...
                return (
                    <span className='captwiki-patch-download-btn' onClick={() => { downLoadPatch() }}>
