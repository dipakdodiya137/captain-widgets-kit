...
const Home = (props) => {
    ...
    const listContent = () => {
        ...
        let extensionListClass = 'captwiki-patch-list';
            ...
            if ('header' === type) {
                ...
                return (
                    <div className='captwiki-accordion-content'>
                        ...
                        <label className='captwiki-accordion-content-label'>
                            <span className='captwiki-accordion-content-text'>{__('Essential Addons for Elementor', 'captain-widgets-kit')}</span>
                        ...
                        <label className='captwiki-accordion-content-label'>
                            <span className='captwiki-accordion-content-text'>{__('Happy Elementor Addons', 'captain-widgets-kit')}</span>
                        ...
                        <label className='captwiki-accordion-content-label'>
                            <span className='captwiki-accordion-content-text'>{__('Royal Elementor Addons', 'captain-widgets-kit')}</span>
    ...
    return (
        <div className="captwiki-browse-page">
            {headerPanel()}
            <div className='captwiki-page-content'>
