...
if ( ! class_exists( 'Captwiki_Animated_Border_3_Ouz5fo25' ) ) {
	...
	class Captwiki_Animated_Border_3_Ouz5fo25 {
		...
		public function captwiki_enqueue_style() {
			$custom_css_url = CAPTWIKI_URL . 'includes/patch-load/patchs/animated-border-3_ouz5fo25/animated-border-3_ouz5fo25.css';
			wp_enqueue_style( 'captwiki-jckevl26-animated-border-3_ouz5fo25', $custom_css_url, array(), time() );
		}
		...
		public function captwiki_register_controls( $element ) {
			...
			$element->start_controls_section(
				'section-e5po5x25',
				array(
					'label'   => esc_html__( 'Animated Border 3', 'captain-widgets-kit' ),
			...
			$element->add_control(
				'switcher_81byeu25',
				array(
					'label'        => esc_html__( 'Enable Animated Border 3', 'captain-widgets-kit' ),
		...
		public function captwiki_render_content( $content, $element ) {
			...
			$dd_style = isset( $settings['switcher_81byeu25'] ) ? $settings['switcher_81byeu25'] : '';

			if ( 'Yes' === $dd_style ) {
				$element->add_render_attribute( '_wrapper', 'class', 'captwiki-animated-border-three' );
	...
	Captwiki_Animated_Border_3_Ouz5fo25::get_instance();
}
