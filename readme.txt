...
Tags: elementor, elementor addon, elementor extension, widgets, customization
...
Yes, this plugin works only with Elementor installed and activated.

= Does it modify Elementor core files? =
No. The plugin extends Elementor widgets without changing any core files.

= Is this plugin beginner-friendly? =
Yes. All added controls appear directly inside the Elementor editor and work like native options.

== Screenshots ==

1. Additional controls added to Elementor widgets
2. Advanced customization options inside the Elementor editor
3. Example of extended widget settings panel
